...
namespace ArtCollective.Data
{
    ...
    {
        private const string ConnectionString = @"Server=DESKTOP-EGKID6D\SQLEXPRESS;Database=ArtCollective2025;Trusted_Connection=True;Encrypt=False;";
